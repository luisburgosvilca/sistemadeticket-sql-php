 ...
 * 
 */
class FormularioAutenticacion //extends AnotherClass
{
...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="st_includes/plugins/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="st_includes/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
